    ...
    <div>
      ...
      <div className="pricing-container">
        ...
        <div className="pricing-tier">
          <h2>Basic Plan</h2>
          <p className="price"><s>$4000 CAD per year</s></p>
          <p className="sale-price">$ {basicPlanSalePrice} CAD per year</p> {/* Sale price */}
        ...
        <div className="pricing-tier recommended">
          ...
          <p className="price"><s>$6000 CAD per year</s></p>
          
          <p className="sale-price">$ {professionalPlanSalePrice} CAD per year</p> {/* Sale price */}
